...
# 🎮 Together in Forgotten Lands — Community Edition

**Explore, rebuild, and uncover the secrets of forgotten lands together.**
...
Together in Forgotten Lands is an adventure and simulation game set across mysterious, long-abandoned regions filled with ruins, hidden paths, and scattered survivors. Players explore hand-crafted environments, gather resources, rebuild settlements, craft tools, and piece together the story of why the lands were forgotten. This Community Edition is a standalone build that includes all content, runs fully offline, and requires no storefront or additional software.

This standalone build is for PC players who enjoy relaxed adventure and simulation games and want a complete, offline experience in a single self-contained package.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3424990/cfa9702e1191482959e1c629bef0f87bb7456ae5/ss_cfa9702e1191482959e1c629bef0f87bb7456ae5.1920x1080.jpg?t=1786115667" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3424990/903bb3d8c97d93f6202358144ec79a1f7e8ef141/ss_903bb3d8c97d93f6202358144ec79a1f7e8ef141.1920x1080.jpg?t=1786115667" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3424990/9073fed7fe2017ce9c12fd67bf7eb566721a092c/ss_9073fed7fe2017ce9c12fd67bf7eb566721a092c.1920x1080.jpg?t=1786115667" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- 🗺️ **Expansive Exploration** — Journey through hand-crafted regions, crumbling ruins, and hidden valleys.
- 🏕️ **Settlement Building** — Gather resources and restore abandoned outposts into thriving hubs.
- 🤝 **Co-op Adventure** — LAN or direct connection supported for shared expeditions.
- 🧩 **Puzzles and Secrets** — Solve environmental puzzles to enable new paths and uncover lore.
- ⚒️ **Crafting System** — Craft tools, gear, and structures from materials found in the wild.
- 📖 **Story-Driven Quests** — Follow a narrative campaign revealing the fate of the forgotten lands.
- 💻 **Fully Offline** — Self-contained package, ready to play immediately with no additional software.

- **Compression:** Lossless
- **Install Time:** ~4 minutes on SSD, ~10 on HDD
- **Recoding:** none
...
| **Processor** | Intel Core i3-2100 / AMD FX-4300 | Intel Core i5-8400 / AMD Ryzen 5 2600 |
| **RAM** | 4 GB | 8 GB |
| **Graphics** | NVIDIA GeForce GTX 660 / AMD Radeon HD 7850, 2 GB VRAM | NVIDIA GeForce GTX 1060 / AMD Radeon RX 580, 6 GB VRAM |
| **Storage** | 8 GB available space | 8 GB available space, SSD recommended |
| **Additional** | DirectX 11 compatible sound card | DirectX 11 compatible sound card; gamepad supported |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\TogetherinForgottenLands\Saved`
